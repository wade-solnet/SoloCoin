...
/**
   ...
   An ownable vesting schedule for the SoloCToken, the tokens can only be
   ...
   amount of periods and a cSoloCf. The available amount of tokens will
   be calculated based on the balance of SoloCTokens of the contract at
   that time.
 */
...
contract VestedPayment is Ownable {
  ...
  function VestedPayment(
    ...
    require(_cSoloCfDuration < _totalPeriods);
    require(_tokens > 0);
