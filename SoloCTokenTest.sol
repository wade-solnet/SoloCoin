 ...
 */
contract SoloCTokenTest is StandardToken, ERC827Token, BurnableToken, MintableToken, PausableToken {
  // Token Name
  string public constant NAME = "Líf";

  // Token Symbol
  string public constant SYMBOL = "SoloC";

  // Token decimals
  uint public constant DECIMALS = 18;

  // Max SoloC faucet (50 tokens)
  uint256 public constant MAX_SoloC_FAUCET = 50000000000000000000;
   ...
   */
  function faucetSoloC() public {
    uint256 amount = MAX_SoloC_FAUCET.sub(balances[msg.sender]);
  ...
  function burn(uint256 _value) public whenNotPaused {
    ...
    // all the SoloC by just looking at those events
